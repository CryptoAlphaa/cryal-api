    ...
    route('rooms') do |routing|
      ...
      routing.is do
        routing.get do
          ...
          packet = if room_id.nil?
                     AccountService::Room::FetchAll.call(requestor: @auth_account)
                   else
                     AccountService::Room::FetchOne.call(@auth, room_id)
                   end
          response.status = 200
            ...
            routing.on 'waypoints' do
              routing.is do
                ...
                routing.post do
                  ...
                  output = AccountService::Waypoint::Create.call(@auth, room_id, plan_id,
                                                                 new_waypoint)
                  response.status = 201
                ...
                routing.get do
                  ...
                  waypoints = AccountService::Waypoint::Fetch.call(@auth, room_id, plan_id,
                                                                   waypoint_number)
                  response.status = 200

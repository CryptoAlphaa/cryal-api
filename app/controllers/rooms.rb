...
module Cryal
  ...
  class Api < Roda # rubocop:disable Metrics/ClassLength
    include Cryal
    route('rooms') do |routing| # rubocop:disable Metrics/BlockLength
      ...
      routing.on String do |room_id| # rubocop:disable Metrics/BlockLength
        ...
        routing.on 'plans' do # rubocop:disable Metrics/BlockLength
          ...
          routing.on String do |plan_id| # rubocop:disable Metrics/BlockLength
            routing.on 'waypoints' do # rubocop:disable Metrics/BlockLength
              routing.is do # rubocop:disable Metrics/BlockLength
                ...
                routing.post do
                  ...
                  output = Cryal::AccountService::Waypoint::Create.call(@auth_account, room_id,
                                                                        plan_id, new_waypoint)
                  response.status = 201
                ...
                routing.get do
                  ...
                  waypoints = Cryal::AccountService::Waypoint::Fetch.call(@auth_account, room_id,
                                                                          plan_id, waypoint_number)
                  response.status = 200
